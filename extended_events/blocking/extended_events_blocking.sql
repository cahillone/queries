-- Source: https://www.brentozar.com/archive/2014/03/extended-events-doesnt-hard/
...
(SET filename = N'F:\Backup\Temp\trace\blocked_process.xel',
     metadatafile = N'F:\Backup\Temp\trace\blocked_process.xem',
     max_file_size=(65536),
...
WITH events_cte AS (
  ...
  FROM    sys.fn_xe_file_target_read_file
    ('F:\Backup\Temp\trace\blocked_process*.xel',
     'F:\Backup\Temp\trace\blocked_process*.xem',
     null, null)
...
---------------------------------------
--For the blocked process report viewer
CREATE TABLE bpr (
    EndTime DATETIME,
    TextData XML,
